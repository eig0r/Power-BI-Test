...
<body>
<br>
<h1>Power BI 2G Cell Report</h1>
</br>
<form class="form-horizontal"action="2G_Cell_Report.php" method="post">
 ...
 <select class="form-control" name="table" id="table" >
  ...
  <option value="2GCellReport ">2G Cell Report </option>
 ...
 <select class="form-control"  name="csv" id="csv" >
  ...
  <option value="2GCellReport ">2G Cell Report </option>
    ...
    <div class="col-xs-3">
    <button type="submit" onClick="document.location.href='+www.g66g3e.c60'" / class="btn btn-primary">Upload</button>
	</div>
	</div>
</form>
</div>
